...
if(!isset($_SESSION["cial"])){
    ...
    if(isset($_GET["entrada"])){
        $sql ="insert into ".$_SESSION["cial"]."registro values('Entrada','{$_POST['motivo']}','{$_POST['persauto']}','{$_POST['fecha']}');";
        $sql2="insert into registro_diario values('Entrada','{$_POST['motivo']}','{$_POST['fecha']}','{$_POST['hora']}','{$_SESSION['cial']}');";
