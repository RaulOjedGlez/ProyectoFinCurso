...
<body>
    ...
    <div class="bloque">
        <form action="../src_php/logicaRegistro.php?tipo=entrada" method="post">
    ...
    <div class="bloque">
        <form action="../src_php/logicaRegistro.php?tipo=salida" method="post">
            ...
            <select id="persauto" name="persauto">
